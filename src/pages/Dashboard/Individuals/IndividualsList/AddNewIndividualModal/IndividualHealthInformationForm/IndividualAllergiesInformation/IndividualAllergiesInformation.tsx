...
export default function IndividualAllergiesInformationForm({
  ...
  const [foodAllergiesModel, setFoodAllergiesModel] = useState({
    ...
    value: userState?.allergies?.food,
    error: "",
    validated: false,
  });
  ...
  const [medAllergiesModel, setMedAllergiesModel] = useState({
    ...
    value: userState?.allergies?.meds,
    error: "",
    validated: false,
  });
  ...
  const [otherAllergiesModel, setOtherAllergiesModel] = useState({
    ...
    value: userState?.allergies?.others,
    error: "",
    validated: false,
  });
      ...
      <div className={styles.form_content}>
        <div className={styles.row}>
          <TagInputField
            ...
            onTagAdded={(tags: Array<string>) =>
              setAllergy(tags, foodAllergiesModel, setFoodAllergiesModel)
            }
          />
          ...
          <TagInputField
            ...
            onTagAdded={(tags: Array<string>) =>
              setAllergy(tags, medAllergiesModel, setMedAllergiesModel)
            }
          />
          ...
          <TagInputField
            ...
            onTagAdded={(tags: Array<string>) =>
              setAllergy(tags, otherAllergiesModel, setOtherAllergiesModel)
            }
          />
        </div>
      </div>
