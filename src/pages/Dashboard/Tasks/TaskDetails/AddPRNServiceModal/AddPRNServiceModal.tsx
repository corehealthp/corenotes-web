...
export default function AddPRNServiceModal({
  closeModal,
}: {
  closeModal: () => void;
}) {
  ...
  const individualList = useFetchIndividualListSelector(
    individualState.individuals.currentListPage
  );

  useEffect(() => {
    setIndividualModel((state:any) => ({
      ...state,
  ...
  function selectOption(
    ...
    if (model.name === "selected-individual") {
      setIndividualServicesState((state:any) => ({
        ...state,
        status: "LOADING",
        error: false,
        message: "",
      ...
      fetchIndividualServicesAction(model.value!.value!)
        .then((response) => {
          ...
          setRequestedServiceModel((state:any) => ({
            ...state,
        ...
        <div className={styles.body}>
          <DropDownField
            ...
            onSelect={(optionIndex: number) =>
              selectOption(optionIndex, individualModel, setIndividualModel)
            }
          />
          ...
          <RowContainer>
            <InputField
              ...
              onInput={(value: string) =>
                setInput(value, serviceStartDateModel, setServiceStartDateModel)
              }
            />
            ...
            <InputField
              ...
              onInput={(value: string) =>
                setInput(value, serviceTimeModel, setServiceTimeModel)
              }
            />
          </RowContainer>
        </div>
