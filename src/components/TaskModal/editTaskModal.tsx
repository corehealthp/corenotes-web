...
console.log("individualService",individualService)
  ...
  const submitEditForm = () => {
    ...
    patchFetch(
      `/individuals/${patient?.individualId}/services/${patient?.serviceId}`,
      {
        ...
        status: individualService?.status,
      }
    ).then((response: any) => {
  ...
  return (
    <>
      <Transition appear show={isEditTaskOpen} as={Fragment}>
                ...
                <Dialog.Panel className="lg:w-[37%] md:w-5/12 w-full border border-[#ccc] transform overflow-hidden rounded-2xl bg-[#ECF4E7] p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="px-4 border border-gray-400 py-2 rounded">
                      ...
                      >
                        <option value="">{patient?.serviceType?.toUpperCase()}</option>
                  ...
                  <div className="flex  justify-end w-full gap-4 mt-6">
                    <button
                      onClick={() => closeModal()}
                      className=" p-2   w-[200px] text-[#16ADF5] bg-gray-200"
                    >
                      Cancel
                    </button>
                    {loading ? (
